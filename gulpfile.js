...
gulp.task('chrome_pc', function() {
	debugger;
	test.chrome_desktop(function() {
		console.log("Drivers got initialized successfully.");
		test.run_desktop_chrome(function(){
		console.log("Testcases got executed successfully.");
		GLOBAL.desktopdriver.quit(5000);
		});	
	});
});
